                        ...
                        <div class="">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                @if (auth()->user()->first()->profile_photo_path != null)
                                    <img id="profile_photo"
                                        ...
                                        alt="Photo Profile" class="rounded-full w-16 h-16">
                                @else
                                ...
                                <form action="{{ route('admin.profile.destroy', [Auth::user()->id]) }}" method="post">
                                    @method('delete')
                                    @csrf
                            ...
                            <form action="{{ route('admin.profile.update', [Auth::user()->id]) }}" method="POST"
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <div class="flex items-center mt-1">
                                                ...
                                                {{-- tag input dihidden, menampilkan label diatasss --}}
                                                <input type="file" name="photo" id="choose_profile" accept="image/*" hidden>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Youre Role" type="text" name="role" id="role"
                                                autocomplete="role"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required value="{{ $user->user_roles->name ?? '' }}">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Alex.jones@gmail.com" type="email" name="email" id="email"
                                                autocomplete="email"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Phone" type="number" name="contact_number"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Your Address" type="text" name="address" id="address"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="biography" id="biography" autocomplete="biography"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                rows="4">{{ $user->biography ?? '' }}</textarea>

                                            @if ($errors->has('biography'))
                                                <p class="text-red-500 mb-3 text-sm">{{ $errors->first('biography') }}
                                                </p>
                                            @endif
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    ...
                                    <a href="{{ route('mentor.dashboard.index') }}" type="button"
